...
register(
    id='rpFrankaRobotiqData01-v0',
    entry_point='mj_envs.envs.fm.franka_robotiq_data_v0:FrankaRobotiqData',
    max_episode_steps=50, #50steps*40Skip*2ms = 4s
    kwargs={
        'model_path': '/assets/franka_robotiq.xml',
        'config_path': curr_dir+'/assets/franka_robotiq01.config',
        'nq_arm':7,
        'nq_ee':1,
        'name_ee':'end_effector',
        'obs_keys':[
...
register(
    id='rpFrankaRobotiqData04-v0',
    entry_point='mj_envs.envs.fm.franka_robotiq_data_v0:FrankaRobotiqData',
    max_episode_steps=50, #50steps*40Skip*2ms = 4s
    kwargs={
        'model_path': '/assets/franka_robotiq.xml',
        'config_path': curr_dir+'/assets/franka_robotiq04.config',
        'nq_arm':7,
        'nq_ee':1,
        'name_ee':'end_effector',
        'obs_keys':[
...
register(
    id='rpFrankaRobotiqDataPenn-v0',
    entry_point='mj_envs.envs.fm.franka_robotiq_data_v0:FrankaRobotiqData',
    max_episode_steps=50, #50steps*40Skip*2ms = 4s
    kwargs={
        'model_path': '/assets/franka_robotiq.xml',
        'config_path': curr_dir+'/assets/franka_robotiqpenn.config',
        'nq_arm':7,
        'nq_ee':1,
        'name_ee':'end_effector',
        'obs_keys':[
